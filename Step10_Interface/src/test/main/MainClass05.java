...
public class MainClass05 {
	...
	public static void main(String[] args) {
		...
		Calc c2 = new Calc() {//class __ implements Clac
		...
		//매개변수의 type 은 선언 할 필요가 없다. 매개변수의 갯수만 맞으면 됨.
		Calc c3 =  (a,b)->{
			return 0;
		};
		...
		//매개변수로 전달한 두수의 합이 리턴된다.
		double result1 = add.execute(10, 20);
		//중괄호안에서 따로 실행할 code 가 없다면 중괄호 생략,
		//return 예약어 생략후 리턴할 값만 명시하면 된다.
		Calc add2 = (num1, num2)->num1+num2;//한줄짜리 함수모양을 람다식이라고도 한다.
